...
%%%
%%% @end
%%% Created : 30. 十二月 2015 上午11:59
%%%-------------------------------------------------------------------
-module(sensitive_word_mod).
...
init([]) ->
	...
	ets:new(?ETS_SENSITIVE_WORD_FIRST, [named_table, public, set, {read_concurrency,true}, {write_concurrency,true}]),
	ets:new(?ETS_SENSITIVE_WORD_ALL, [named_table, public, set, {read_concurrency,true}, {write_concurrency,true}]),
	ets:new(?ETS_SENSITIVE_WORD_HASH, [named_table, public, set, {read_concurrency,true}, {write_concurrency,true}]),
	ets:new(?ETS_SENSITIVE_WORD_SINGLE, [named_table, public, set, {read_concurrency,true}, {write_concurrency,true}]),
	sensitive_word_lib:init(),
	{ok, #state{}}.
