...
write_type(Type, DataRecord) ->
	...
	case is_record(DataRecord, Type) of
		true ->
			DataList = util_list:record_to_list(DataRecord),
			?ERR("write_type ~p ~p ~p ",[Type,DataList,WriteTemplateList]),
