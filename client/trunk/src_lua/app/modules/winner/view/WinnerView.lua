...
local WinnerView = WinnerView or class("WinnerView", BaseView)

function WinnerView:ctor(winTag,data,winconfig)
	--self:creatPillar()\
	...
	WinnerView.super.ctor(self,winTag,data,winconfig)
...
function WinnerView:setViewInfo(data)
	if data == nil then 
		data = configHelper:getDarkHouseGoods(3)
	end
