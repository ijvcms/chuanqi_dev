--
-- Author: Yi hanneng
-- Date: 2016-02-26 14:06:46
--
--[[]]
local UIAsynListViewItemEx = import("app.gameui.listViewEx.UIAsynListViewItemEx")
local ExchangeStorageItem = ExchangeStorageItem or class("ExchangeStorageItem", UIAsynListViewItemEx)

function ExchangeStorageItem:ctor(loader, layoutFile)
...
function ExchangeStorageItem:init()
...
function ExchangeStorageItem:setData(data)
...
function ExchangeStorageItem:getData()
	return self.data
end

function ExchangeStorageItem:setSelect(b)
	self.selected = b
...
function ExchangeStorageItem:getSelected()
	return self.selected
end

return ExchangeStorageItem
